#include "dc_qtopengl_user_functions.h"
...
namespace argos {
   ...
   bool CDCQtOpenGLUserFunctionsMouseWheelEventHandler::eventFilter(QObject* pc_object,
                                                                     QEvent* pc_event) {
   ...
   CDCQtOpenGLUserFunctions::CDCQtOpenGLUserFunctions() :
      m_unCameraIndex(0),
      m_unLastSimulationClock(-1) {
      RegisterUserFunction<CDCQtOpenGLUserFunctions, CBuilderBotEntity>(&CDCQtOpenGLUserFunctions::Annotate);
      RegisterUserFunction<CDCQtOpenGLUserFunctions, CPiPuckEntity>(&CDCQtOpenGLUserFunctions::Annotate);
      RegisterUserFunction<CDCQtOpenGLUserFunctions, CDroneEntity>(&CDCQtOpenGLUserFunctions::Annotate);
   }
   ...
   void CDCQtOpenGLUserFunctions::Init(TConfigurationNode& t_tree) {
      /* install the mouse wheel event handler */
      m_pcMouseWheelEventHandler =
         new CDCQtOpenGLUserFunctionsMouseWheelEventHandler(&GetQTOpenGLWidget(), this);
   ...
   void CDCQtOpenGLUserFunctions::DrawInWorld() {
   ...
   void CDCQtOpenGLUserFunctions::EntityMoved(CEntity& c_entity,
   ...
   void CDCQtOpenGLUserFunctions::Annotate(CDebugEntity& c_debug_entity,
   ...
   void CDCQtOpenGLUserFunctions::DrawRing3(const CVector3& c_center, Real f_radius) {
   ...
   void CDCQtOpenGLUserFunctions::DrawArrow3(const CVector3& c_from, const CVector3& c_to) {
      const CCachedShapes& cCachedShapes = CCachedShapes::GetCachedShapes();
   ...
   void CDCQtOpenGLUserFunctions::CCachedShapes::MakeCylinder() {
      /* Side surface */
   ...
   void CDCQtOpenGLUserFunctions::CCachedShapes::MakeCone() {
      /* Cone surface */
      CVector2 cVertex(0.5f, 0.0f);
      CRadians cAngle(CRadians::TWO_PI / GL_NUMBER_VERTICES);
      glBegin(GL_QUAD_STRIP);
   ...
   void CDCQtOpenGLUserFunctions::CCachedShapes::MakeRing() {
      CVector2 cVertex;
      const CRadians cAngle(CRadians::TWO_PI / GL_NUMBER_VERTICES);
      /* draw front surface */
      cVertex.Set(0.5f, 0.0f);     
   ...
   REGISTER_QTOPENGL_USER_FUNCTIONS(CDCQtOpenGLUserFunctions, "dc_qtopengl_user_functions");
