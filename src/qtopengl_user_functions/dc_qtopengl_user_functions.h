...
namespace argos {
   class CDCQtOpenGLUserFunctions;
}
...
namespace argos {
   class CDCQtOpenGLUserFunctionsMouseWheelEventHandler : public QObject {
      Q_OBJECT

   public:
      CDCQtOpenGLUserFunctionsMouseWheelEventHandler(QObject* pc_parent,
                                                      CDCQtOpenGLUserFunctions* pc_user_functions) :
         QObject(pc_parent),
   ...
   private:
      CDCQtOpenGLUserFunctions* m_pcUserFunctions;
   };

   class CDCQtOpenGLUserFunctions : public QObject,
                                     public CQTOpenGLUserFunctions {
      Q_OBJECT

   public:
      CDCQtOpenGLUserFunctions();

      virtual ~CDCQtOpenGLUserFunctions();
   ...
   private:
      ...
      CDCQtOpenGLUserFunctionsMouseWheelEventHandler* m_pcMouseWheelEventHandler;
